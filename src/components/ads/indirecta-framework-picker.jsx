...
import { INDIRECTA_FRAMEWORKS } from "@/lib/video-indirecta-frameworks";
import { cn } from "@/lib/utils";

export function IndirectaFrameworkPicker({ value, onSelect }) {
  return (
    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
      {INDIRECTA_FRAMEWORKS.map((fw, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between gap-2 text-[10px] text-muted-foreground">
              ...
              <span className="font-mono">{fw.beats.length} lessons</span>
            </div>
          </motion.button>
        );
      })}
